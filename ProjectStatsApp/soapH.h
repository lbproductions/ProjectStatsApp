...
#define SOAP_TYPE_double (1)
#endif
SOAP_FMAC3 void SOAP_FMAC4 soap_default_double(struct soap*, double *);
SOAP_FMAC3 double SOAP_FMAC4 soap_out_double(struct soap*, const char*, double, const double *, const char*);
...
SOAP_FMAC3 double SOAP_FMAC4 soap_put_double(struct soap*, const double *, const char*, const char*);
