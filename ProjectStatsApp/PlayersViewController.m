...
- (void)viewDidLoad
{
    ...
    [newManagedObject setValue:@"Niclas Raabe" forKey:@"name"];
    [m_players addObject:newManagedObject];
    ...
    [newManagedObject1 setValue:@"Niklas Wulf" forKey:@"name"];
    [m_players addObject:newManagedObject1];
    
    /*
    Player *player = [[Player alloc] init];
    player.name = @"Niclas Raabe";
